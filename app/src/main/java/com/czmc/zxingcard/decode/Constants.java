...
public class Constants {
    ...
    public static final int restart_preview=0xaa4545;
    public static final int decode_succeeded=0xaa123d;
    public static final int decode_failed=0xaa45454;
    public static final int decode=0xaa45454;
    public static final int return_scan_result=0xaa8888;
    public static final int launch_product_query=0xaa55555;
    public static final int quit=0xaa8886;
}
